...
"""autogenerated by genpy from robmovil_msgs_viejo/Trajectory.msg. Do not edit."""
import sys
...
class Trajectory(genpy.Message):
  _md5sum = "57454e88c8a6ed7b6cbdc51b920bbf17"
  _type = "robmovil_msgs_viejo/Trajectory"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# The header is used to specify the coordinate frame
...
"""
  ...
  _slot_types = ['std_msgs/Header','robmovil_msgs_viejo/TrajectoryPoint[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = robmovil_msgs_viejo.msg.TrajectoryPoint()
        _v11 = val1.transform
