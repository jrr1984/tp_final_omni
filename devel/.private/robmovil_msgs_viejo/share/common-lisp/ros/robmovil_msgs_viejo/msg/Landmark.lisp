...
(cl:defmethod cl:initialize-instance :after ((m <Landmark>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Landmark)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robmovil_msgs_viejo-msg:<Landmark> is deprecated: use robmovil_msgs_viejo-msg:Landmark instead.")))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <Landmark>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robmovil_msgs_viejo-msg:range-val is deprecated.  Use robmovil_msgs_viejo-msg:range instead.")
  (range m))

(cl:ensure-generic-function 'bearing-val :lambda-list '(m))
(cl:defmethod bearing-val ((m <Landmark>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robmovil_msgs_viejo-msg:bearing-val is deprecated.  Use robmovil_msgs_viejo-msg:bearing instead.")
  (bearing m))
