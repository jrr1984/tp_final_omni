...
(cl:defmethod cl:initialize-instance :after ((m <EncoderTicks>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EncoderTicks)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robmovil_msgs_viejo-msg:<EncoderTicks> is deprecated: use robmovil_msgs_viejo-msg:EncoderTicks instead.")))
...
(cl:defmethod ticks_left-val ((m <EncoderTicks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robmovil_msgs_viejo-msg:ticks_left-val is deprecated.  Use robmovil_msgs_viejo-msg:ticks_left instead.")
  (ticks_left m))

(cl:ensure-generic-function 'ticks_right-val :lambda-list '(m))
(cl:defmethod ticks_right-val ((m <EncoderTicks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robmovil_msgs_viejo-msg:ticks_right-val is deprecated.  Use robmovil_msgs_viejo-msg:ticks_right instead.")
  (ticks_right m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EncoderTicks>)))
  ...
  "robmovil_msgs_viejo/EncoderTicks")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EncoderTicks)))
  "Returns string type for a message object of type 'EncoderTicks"
  "robmovil_msgs_viejo/EncoderTicks")
