...
(cl:defclass <LandmarkArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (landmarks
    :reader landmarks
    :initarg :landmarks
    :type (cl:vector robmovil_msgs_viejo-msg:Landmark)
   :initform (cl:make-array 0 :element-type 'robmovil_msgs_viejo-msg:Landmark :initial-element (cl:make-instance 'robmovil_msgs_viejo-msg:Landmark))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LandmarkArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LandmarkArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robmovil_msgs_viejo-msg:<LandmarkArray> is deprecated: use robmovil_msgs_viejo-msg:LandmarkArray instead.")))
...
(cl:defmethod landmarks-val ((m <LandmarkArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robmovil_msgs_viejo-msg:landmarks-val is deprecated.  Use robmovil_msgs_viejo-msg:landmarks instead.")
  (landmarks m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LandmarkArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'landmarks)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'robmovil_msgs_viejo-msg:Landmark))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LandmarkArray>)))
  ...
  "robmovil_msgs_viejo/LandmarkArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LandmarkArray)))
  "Returns string type for a message object of type 'LandmarkArray"
  "robmovil_msgs_viejo/LandmarkArray")
