...
if("TRUE" STREQUAL "TRUE")
  set(rrt_planning_SOURCE_PREFIX /home/juan/catkin_ws/src/rrt_planning)
  set(rrt_planning_DEVEL_PREFIX /home/juan/catkin_ws/devel/.private/rrt_planning)
  ...
  set(rrt_planning_INSTALL_PREFIX /home/juan/catkin_ws/install)
...
if(NOT "/home/juan/catkin_ws/src/rrt_planning/include " STREQUAL " ")
  set(rrt_planning_INCLUDE_DIRS "")
  set(_include_dirs "/home/juan/catkin_ws/src/rrt_planning/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rrt_planning' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rrt_planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/juan/catkin_ws/src/rrt_planning/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/juan/catkin_ws/devel/.private/rrt_planning/lib;/home/juan/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(rrt_planning_EXPORTED_TARGETS "")
