    ...
    {
        publisherProxy->publisher = nh->advertise<robmovil_msgs::EncoderTicks>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "robmovil_msgs/MultiEncoderTicks")
    {
        publisherProxy->publisher = nh->advertise<robmovil_msgs::MultiEncoderTicks>(in->topicName, in->queueSize, in->latch);
    }
