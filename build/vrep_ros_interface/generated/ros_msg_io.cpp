...
void write__robmovil_msgs__EncoderTicks(const robmovil_msgs::EncoderTicks& msg, int stack, const WriteOptions *opt)
{
    try
    {
        simPushTableOntoStackE(stack);
        ...
        try
        {
            // write field 'ticks_left'
            simPushStringOntoStackE(stack, "ticks_left", 0);
            write__std_msgs__Int32(msg.ticks_left, stack, opt);
            simInsertDataIntoStackTableE(stack);
        }
        catch(exception& ex)
        {
            std::string msg = "field 'ticks_left': ";
            msg += ex.what();
            throw exception(msg);
        }
        try
        ...
        try
        {
            // write field 'ticks_right'
            simPushStringOntoStackE(stack, "ticks_right", 0);
            write__std_msgs__Int32(msg.ticks_right, stack, opt);
            simInsertDataIntoStackTableE(stack);
        }
        catch(exception& ex)
        {
            std::string msg = "field 'ticks_right': ";
            msg += ex.what();
            throw exception(msg);
        }
    }
    ...
    {
        std::string msg = "write__robmovil_msgs__EncoderTicks: ";
        msg += ex.what();
        throw exception(msg);
    }
}
...
void read__robmovil_msgs__EncoderTicks(int stack, robmovil_msgs::EncoderTicks *msg, const ReadOptions *opt)
{
    try
    {
        if(simGetStackTableInfoE(stack, 0) != sim_stack_table_map)
        ...
        while(numItems >= 1)
        {
            ...
            if((str = simGetStackStringValueE(stack, &strSz)) != NULL && strSz > 0)
            {
                ...
                if(0) {}
                else if(strcmp(str, "ticks_left") == 0)
                {
                    try
                    {
                        // read field 'ticks_left'
                        read__std_msgs__Int32(stack, &(msg->ticks_left), opt);
                    }
                    catch(exception& ex)
                    {
                        std::string msg = "field ticks_left: ";
                ...
                else if(strcmp(str, "ticks_right") == 0)
                {
                    try
                    {
                        // read field 'ticks_right'
                        read__std_msgs__Int32(stack, &(msg->ticks_right), opt);
                    }
                    catch(exception& ex)
                    {
                        std::string msg = "field ticks_right: ";
    ...
    {
        std::string msg = "read__robmovil_msgs__EncoderTicks: ";
        msg += ex.what();
        throw exception(msg);
    }
}
...
void ros_callback__robmovil_msgs__EncoderTicks(const boost::shared_ptr<robmovil_msgs::EncoderTicks const>& msg, SubscriberProxy *proxy)
{
    int stack = -1;
    try
    {
        stack = simCreateStackE();
        write__robmovil_msgs__EncoderTicks(*msg, stack, &(proxy->wr_opt));
        simCallScriptFunctionExE(proxy->topicCallback.scriptId, proxy->topicCallback.name.c_str(), stack);
        simReleaseStackE(stack);
        stack = -1;
    }
    catch(exception& ex)
    {
        if(stack != -1)
            simReleaseStack(stack); // don't throw
        std::string msg = "ros_callback__robmovil_msgs__EncoderTicks: ";
        msg += ex.what();
        simSetLastError(proxy->topicCallback.name.c_str(), msg.c_str());
    }
}
...
void write__robmovil_msgs__MultiEncoderTicks(const robmovil_msgs::MultiEncoderTicks& msg, int stack, const WriteOptions *opt)
{
    try
    {
        simPushTableOntoStackE(stack);
        ...
        {
            // write field 'ticks'
            simPushStringOntoStackE(stack, "ticks", 0);
            simPushTableOntoStackE(stack);
            for(int i = 0; i < msg.ticks.size(); i++)
            {
                write__int32(i + 1, stack, opt);
                write__std_msgs__Int32(msg.ticks[i], stack, opt);
                simInsertDataIntoStackTableE(stack);
            }
            simInsertDataIntoStackTableE(stack);
        }
    ...
    {
        std::string msg = "write__robmovil_msgs__MultiEncoderTicks: ";
        msg += ex.what();
        throw exception(msg);
    }
}
...
void read__robmovil_msgs__MultiEncoderTicks(int stack, robmovil_msgs::MultiEncoderTicks *msg, const ReadOptions *opt)
{
    try
    {
        if(simGetStackTableInfoE(stack, 0) != sim_stack_table_map)
                ...
                else if(strcmp(str, "ticks") == 0)
                {
                    try
                    {
                        ...
                        for(int i = 0; i < numItems1; i++)
                        {
                            ...
                            simMoveStackItemToTopE(stack, oldsz1 - 1); // move value to top
                            std_msgs::Int32 v;
                            read__std_msgs__Int32(stack, &v, opt);
                            msg->ticks.push_back(v);
                        }
                    }
                    catch(exception& ex)
                    {
    ...
    {
        std::string msg = "read__robmovil_msgs__MultiEncoderTicks: ";
        msg += ex.what();
        throw exception(msg);
    }
}
...
void ros_callback__robmovil_msgs__MultiEncoderTicks(const boost::shared_ptr<robmovil_msgs::MultiEncoderTicks const>& msg, SubscriberProxy *proxy)
{
    int stack = -1;
    try
    {
        stack = simCreateStackE();
        write__robmovil_msgs__MultiEncoderTicks(*msg, stack, &(proxy->wr_opt));
        simCallScriptFunctionExE(proxy->topicCallback.scriptId, proxy->topicCallback.name.c_str(), stack);
        simReleaseStackE(stack);
        stack = -1;
    }
    catch(exception& ex)
    {
        if(stack != -1)
            simReleaseStack(stack); // don't throw
        std::string msg = "ros_callback__robmovil_msgs__MultiEncoderTicks: ";
        msg += ex.what();
        simSetLastError(proxy->topicCallback.name.c_str(), msg.c_str());
    }
}
