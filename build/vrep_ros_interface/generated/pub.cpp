    ...
    else if(publisherProxy->topicType == "robmovil_msgs/EncoderTicks")
    {
        robmovil_msgs::EncoderTicks msg;
        read__robmovil_msgs__EncoderTicks(p->stackID, &msg, &(publisherProxy->rd_opt));
        publisherProxy->publisher.publish(msg);
    }
    else if(publisherProxy->topicType == "robmovil_msgs/MultiEncoderTicks")
    {
        robmovil_msgs::MultiEncoderTicks msg;
        read__robmovil_msgs__MultiEncoderTicks(p->stackID, &msg, &(publisherProxy->rd_opt));
        publisherProxy->publisher.publish(msg);
    }
