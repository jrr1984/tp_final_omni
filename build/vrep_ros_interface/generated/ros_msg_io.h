...
void write__robmovil_msgs__EncoderTicks(const robmovil_msgs::EncoderTicks& msg, int stack, const WriteOptions *opt = NULL);

void read__robmovil_msgs__EncoderTicks(int stack, robmovil_msgs::EncoderTicks *msg, const ReadOptions *opt = NULL);
...
void write__robmovil_msgs__MultiEncoderTicks(const robmovil_msgs::MultiEncoderTicks& msg, int stack, const WriteOptions *opt = NULL);

void read__robmovil_msgs__MultiEncoderTicks(int stack, robmovil_msgs::MultiEncoderTicks *msg, const ReadOptions *opt = NULL);
