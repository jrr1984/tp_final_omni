    ...
    else if(in->topicType == "robmovil_msgs/EncoderTicks")
    {
        subscriberProxy->subscriber = nh->subscribe<robmovil_msgs::EncoderTicks>(in->topicName, in->queueSize, boost::bind(ros_callback__robmovil_msgs__EncoderTicks, _1, subscriberProxy));
    }
    else if(in->topicType == "robmovil_msgs/MultiEncoderTicks")
    {
        subscriberProxy->subscriber = nh->subscribe<robmovil_msgs::MultiEncoderTicks>(in->topicName, in->queueSize, boost::bind(ros_callback__robmovil_msgs__MultiEncoderTicks, _1, subscriberProxy));
    }
